...
function Toolbar(props: ToolbarProps) {
    ...
    const [searchPlaceholder, setSearchPlaceholder] = useState<string>(`${t('common.search')} (${modKeyString()} + f)`);
        ...
        <Flex w="100%" align="stretch">
            ...
            <Button.Group mx="sm">
                ...
                <Menu shadow="md" width="10rem" withinPortal returnFocus middlewares={{ shift: true, flip: false }}>
                    <Menu.Target>
                        <ToolbarButton title={t('toolbar.priority')}>
            ...
            <TextInput mx="sm" ref={searchRef}
                ...
                onFocus={() => setSearchPlaceholder(t('table.searchPlaceholder'))}
                onBlur={() => setSearchPlaceholder(`${t('common.search')} (${modKeyString()} + f)`)}
